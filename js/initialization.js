...
function initialize(a) {
	...
	window.op = 0;
	window.saveState = sessionStorage.getItem("saveState") || "{}";
	if (saveState !== "{}") {
		op = 1;
	}
	...
	if (a != 1) {
		...
		$(window).unload(function() {
			...
			if (gameState == 1 || gameState == -1 || gameState === 0) sessionStorage.setItem("saveState", exportSaveState());
			else sessionStorage.setItem("saveState", "{}");
		});
