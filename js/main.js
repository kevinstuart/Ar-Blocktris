...
function init(b) {
	...
	$("#pauseBtn").attr('src',"./images/btn_pause.png");
	hideUIElements();
	var saveState = sessionStorage.getItem("saveState") || "{}";
